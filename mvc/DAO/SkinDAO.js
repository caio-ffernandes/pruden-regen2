...
registrarSkin(categoria, nome, descricao, genero, valor, raridade, foto1,foto2,promocoes){
    ...
    this.#conexao.insertSkin(skin.categoriaSkin,skin.nomeSkin,  skin.descricaoSkin ,  skin.generoSkin,skin.valorSkin,skin.raridade,skin.foto1,skin.foto2,skin.promocoes)
}
async atualizarSkin(id,categoria, nome, descricao, genero, valor, raridade, foto1,foto2,promocoes){
    ...
    const dt = await this.#conexao.updateSkin(skin.categoriaSkin,skin.nomeSkin,  skin.descricaoSkin ,  skin.generoSkinraridade,skin.valorSkin,skin.raridade,skin.foto1,skin.foto2,skin.promocoes,skin.id)
    return dt
}
